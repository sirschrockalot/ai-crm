...
const ScriptBuilderPage: React.FC = () => {
  ...
  const updateQuestion = (id: string, updates: Partial<ScriptQuestion>) => {
    setQuestions(
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await atsService.createScript(script);
      toast({
        title: 'Success',
          ...
          <VStack align="stretch" spacing={6}>
            <HStack>
              ...
              <VStack align="start" spacing={1} flex={1}>
                <Heading size="lg">Create Interview Script</Heading>
                <Text color="gray.600">
                  Build a structured interview script for phone screenings
                </Text>
              </VStack>
              <Button
                colorScheme="blue"
